...
2. [Camera & View System](#camera--view-system)
3. [Controls](#controls)
4. [Princess Character](#princess-character)
5. [Heart Gun & Combat](#heart-gun--combat)
6. [Horse Types & AI](#horse-types--ai)
7. [Unicorn Transformation](#unicorn-transformation)
8. [Environment & Obstacles](#environment--obstacles)
9. [Levels](#levels)
10. [UI & HUD](#ui--hud)
...
15. [Asset Reference](#asset-reference)
...
- Children ages 5-12
- Casual gamers
- Fans of cute/kawaii aesthetics
...
- Use `THREE.BoxGeometry` with `bevelEnabled: true` in ExtrudeGeometry where applicable
- Apply subtle edge rounding via geometry modifiers or custom shaders
- Maintain blocky proportions while softening visual harshness
- Eyes, accessories, and small details can remain spherical for contrast
